                ...
                <div class="col-sm-10 text-left"> 
                    ...
                    <div class="row">
                        <div class="col-sm-8 well col-sm-offset-2"> 
                            <form name="formulaireAjoutClient" class="form-horizontal" role="form" method="get" action="controllerBackOffice">
                                <div class="modal-header">
                                    <h1 class="text-center">Création d'un nouveau client</h1>
                                </div>
                                <div class="row"><p>     </p></div>  
                                
                                <div class="form-group">
                                    <label for="typeClient" class="col-sm-4 control-label">Type de client</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="pwd" class="col-sm-4 control-label">Mot de passe</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="col-sm-offset-4 col-sm-8">
                                    <button type="reset" class="btn btn-primary col-sm-offset-1">Remettre à Zéro</button>
                                    <button type="submit" class="btn btn-primary col-sm-offset-3">Valider</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="well text-center"> 
                            <a href="#infoParticuliers" class="btn btn-info" data-toggle="collapse">Afficher la liste des particuliers</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td ><a href="controllerBackOffice?action=modifierParticulier&idClient=<%= part.getId()%>"> Modifier </a>
                                    </td>
                                </tr> 
                                <%}%>
                            </tbody>
                    ...
                    <div class="row">
                        <div class="well text-center"> 
                            <a href="#infoEntreprises" class="btn btn-info" data-toggle="collapse">Afficher la liste des entreprises</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td ><a href="controllerBackOffice?action=archiverClient&idClient=<%= entr.getId()%>"> Archiver </a>
                                    </td>
                                    <td ><a href="controllerBackOffice?action=modifierEntreprise&idClient=<%= entr.getId()%>"> Modifier </a>
                                    </td>
                                </tr> 
                                <%}%>
                            </tbody>
